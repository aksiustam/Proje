    ...
    <div class="col-sm-12">
        <div class="panel panel-default text-left">
                <div class="panel-body">    
                    <h2 class="text-danger"> &nbsp;Ögrenci Giriş</h2>  
                </div>
        </div>
    </div>
</div> 
...
<div class="row">
	<div class="col-sm-12">	
		<div class="well well-sm">
		 	...
		 	<form action="?url=Ogrenci-Ekle" method="POST" enctype="multipart/form-data">
		 	<table>
                    ...
                    <td colspan="7"> 
                        ...
                        <?php 
                                ...
                                if($_SESSION['Yetki'] == '1')
                                {
                                            ...
                                            echo '<input class="form-control" name="ogrno"  placeholder="Ögrenci No giriniz" pattern="[0-9]{9}" maxlength="9" value="'.$_SESSION['Kullanici_adi'].'" readonly>';

                                }
                                else {
                                       echo '<input class="form-control" name="ogrno"  placeholder="Ögrenci No giriniz" pattern="[0-9]{9}" maxlength="9" >';        
                                }   
                ...
                <tr> 
                    ...
                    <td colspan="9"> 
                        <div class="form-inline">
                           <input class="form-control" name="ogradsoyad"  placeholder="Ad Soyad Girin"  style="width: 330px" pattern="[^0-9,+%*]{2,}" maxlength="64">  
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td colspan="3" height="50">Fotograf Seçin :</td>
                    <td colspan="7">    
                ...
                <tr>
                    <td colspan=3 height="100px" >Öğrenci Konya adresi</td>
                     <td colspan=10 >
                ...
                <tr>
                    ...
                    <td colspan=7>
                         <div class="form-inline">
                           <input class="form-control" type="email" name="ogrmail"  placeholder="E-posta giriniz"  pattern=".{6,50}" maxlength="50">  
                        </div>
                    </td>
                </tr>
                 ...
                 <tr>
                    <td colspan=4 rowspan="2" height="100px" >Konya dışından geliyorsa diğer adresi</td>
            ...
            <col width="5%"><col width="5%"> 
                ...
                <tr>
                   <td colspan=2 rowspan="2" height="50px"> Anne</td>
                ...
                <tr>
                   <td colspan=2 rowspan="2" height="50px"> Baba</td>
                    <td colspan=2>Adı Soyadı</td>
                ...
                <tr>
                    ...
                    <td colspan=6 height="90px" >Ailede bir arada yaşayan birey sayısı ve geçim sorumluluğunu taşıyan kişinin kim olduğu</td>
                    <td colspan=11  >
                ...
                <tr>
                    ...
                    <td colspan=6 height="90px" >Kardeş(ler)in sayısı eğitim/iş durumları</td>
                    <td colspan=11>
                ...
                <tr>
                    ...
                    <td colspan=4 rowspan="3" height="130px" >Öğrenci Sağlık Bilgileri </td>
              ...
              <table>
                ...
                <tr>
                    ...
                    <td colspan=3>
                     ...
                     <td colspan=5>
                         <div class="form-inline">
                        (Açıklayınız..):  &nbsp; <input class="form-control" name="yakındurumad"  maxlength="15" style="width:90px" >   
                        </div>
                    </td>
                </tr>
                <tr>

                    <td colspan=5 height="110px" >Belirtmek istediği özel durumlar (Yoksa boş bırakın) :</td>
                    <td colspan=15>
